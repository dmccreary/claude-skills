...
# Google Analytics — Feature #25: Register a Book with GA4

> Formerly the standalone skill `register-book-analytics`.

This guide registers a new MkDocs Material site as a Google Analytics 4 (GA4) property,

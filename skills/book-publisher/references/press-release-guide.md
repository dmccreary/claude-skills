...
> Formerly the standalone skill `press-release-generator`.

## Overview

This guide writes a professional press release that announces an intelligent
...
- **linkedin-post-guide.md** (this skill) — social-post version of the same news
- **readme-guide.md** (this skill) — GitHub project documentation

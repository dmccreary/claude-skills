...
# Text-to-Speech Guide (ElevenLabs)

> Formerly the standalone skill `text-to-speech`.

Generate natural speech from text - supports 70+ languages, multiple models for quality vs latency tradeoffs.

> **Setup:** See [Installation Guide](references/tts-installation.md). For JavaScript, use `@elevenlabs/*` packages only.
...
See [references/tts-streaming.md](references/tts-streaming.md) for WebSocket streaming.
...
- [Installation Guide](references/tts-installation.md)
- [Streaming Audio](references/tts-streaming.md)
- [Voice Settings](references/tts-voice-settings.md)

...
# PowerPoint Lecture Deck Guide (pptxgenjs)

> Formerly the standalone skill `textbook-to-presentation-generator`.
...
Create a Node.js script that uses pptxgenjs to generate the .pptx file. Read `references/pptx-slide-patterns.md` for the reusable slide pattern library.
...
- `references/pptx-slide-patterns.md` — Reusable pptxgenjs code patterns for each slide type
- `references/pptx-speaker-notes-guide.md` — How to write effective speaker notes

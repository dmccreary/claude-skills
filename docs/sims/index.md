---
title: List of MicroSims for Claude Skills Course
description: A list of all the MicroSims used in the Claude Skills course
...
-   **[4-Hour Token Window Visualization](./4-hour-token-window-visualization/index.md)**
    ...
    ![4-Hour Token Window Visualization](./4-hour-token-window-visualization/4-hour-token-window-visualization.png)
...
-   **[5-Hour Token Window Visualization](./5-hour-token-window-visualization/index.md)**
    ...
    ![5-Hour Token Window Visualization](./5-hour-token-window-visualization/5-hour-token-window-visualization.png)
...
-   **[Adding Taxonomy to CSV Workflow](./adding-taxonomy-workflow/index.md)**
    ...
    ![Adding Taxonomy to CSV Workflow](./adding-taxonomy-workflow/adding-taxonomy-workflow.png)
...
-   **[Admonition Types Interactive Reference](./admonition-types-interactive-reference/index.md)**
    ...
    ![Admonition Types Interactive Reference](./admonition-types-interactive-reference/admonition-types-interactive-reference.png)
...
-   **[Algorithm Visualization with Step Controls MicroSim](./algorithm-visualization-with-step-controls-microsim/index.md)**
    ...
    ![Algorithm Visualization with Step Controls MicroSim](./algorithm-visualization-with-step-controls-microsim/algorithm-visualization-with-step-controls-microsim.png)
...
-   **[Average Dependencies Distribution Bar Chart](./average-dependencies-distribution/index.md)**
    ...
    ![Average Dependencies Distribution Bar Chart](./average-dependencies-distribution/average-dependencies-distribution.png)
...
-   **[Basic MicroSim Template Structure](./basic-microsim-template-structure/index.md)**
    ...
    ![Basic MicroSim Template Structure](./basic-microsim-template-structure/basic-microsim-template-structure.png)
...
-   **[Bloom's Taxonomy 1956 vs 2001 Comparison](./bloom-s-taxonomy-1956-vs-2001-comparison/index.md)**
    ...
    ![Bloom's Taxonomy 1956 vs 2001 Comparison](./bloom-s-taxonomy-1956-vs-2001-comparison/bloom-s-taxonomy-1956-vs-2001-comparison.png)
...
-   **[Bloom's Taxonomy Application Distribution in Quality Courses](./bloom-s-taxonomy-application-distribution-in-quality-courses/index.md)**
    ...
    ![Bloom's Taxonomy Application Distribution in Quality Courses](./bloom-s-taxonomy-application-distribution-in-quality-courses/bloom-s-taxonomy-application-distribution-in-quality-courses.png)
...
-   **[Bloom's Taxonomy Distribution Analyzer Chart](./bloom-s-taxonomy-distribution-analyzer-chart/index.md)**
    ...
    ![Bloom's Taxonomy Distribution Analyzer Chart](./bloom-s-taxonomy-distribution-analyzer-chart/bloom-s-taxonomy-distribution-analyzer-chart.png)
...
-   **[Book Build Workflow](./book-build-workflow/index.md)**
    ...
    ![Book Build Workflow](./book-build-workflow/book-build-workflow.png)
...
-   **[Certificate of Completion Generator](./certificate-generator/index.md)**
    ...
    ![Certificate of Completion Generator](./certificate-generator/certificate-generator.png)
...
-   **[Chapter Content Generation Workflow Timeline](./chapter-content-generation-timeline/index.md)**
    ...
    ![Chapter Content Generation Workflow Timeline](./chapter-content-generation-timeline/chapter-content-generation-timeline.png)
...
-   **[Chapter Index File Structure](./chapter-index-structure/index.md)**
    ...
    ![Chapter Index File Structure](./chapter-index-structure/chapter-index-structure.png)
...
-   **[Chapter Organization Workflow Diagram](./chapter-organization-workflow/index.md)**
    ...
    ![Chapter Organization Workflow Diagram](./chapter-organization-workflow/chapter-organization-workflow.png)
...
-   **[Claude Code Memory Layers](./claude-code-memory-layers/index.md)**
    ...
    ![Claude Code Memory Layers](./claude-code-memory-layers/claude-code-memory-layers.png)
...
-   **[Claude Code T-Shirt Design](./claude-code-tshirt-design/index.md)**
    ...
    ![Claude Code T-Shirt Design](./claude-code-tshirt-design/claude-code-tshirt-design.png)

    Interactive MicroSim for intelligent textbook learning workflows.

-   **[Claude Code Workflow Diagram](./claude-code-workflow-diagram/index.md)**

    ![Claude Code Workflow Diagram](./claude-code-workflow-diagram/claude-code-workflow-diagram.png)
...
-   **[Color Accessibility Checker MicroSim](./color-accessibility-checker-microsim/index.md)**
    ...
    ![Color Accessibility Checker MicroSim](./color-accessibility-checker-microsim/color-accessibility-checker-microsim.png)
...
-   **[Color Wheel with Named Colors](./color-wheel-with-named-colors/index.md)**
    ...
    ![Color Wheel with Named Colors](./color-wheel-with-named-colors/color-wheel-with-named-colors.png)
...
-   **[Command-Line Interface Basics Interactive Infographic](./command-line-interface-basics-interactive-infographic/index.md)**
    ...
    ![Command-Line Interface Basics Interactive Infographic](./command-line-interface-basics-interactive-infographic/command-line-interface-basics-interactive-infographic.png)
...
-   **[Concept Count by Course Duration](./concept-count-by-course-duration/index.md)**
    ...
    ![Concept Count by Course Duration](./concept-count-by-course-duration/concept-count-by-course-duration.png)
...
-   **[Concept Depth Distribution Analysis](./concept-depth-distribution-analysis/index.md)**
    ...
    ![Concept Depth Distribution Analysis](./concept-depth-distribution-analysis/concept-depth-distribution-analysis.png)
...
-   **[Concept Granularity Spectrum Visualization](./concept-granularity-spectrum-visualization/index.md)**
    ...
    ![Concept Granularity Spectrum Visualization](./concept-granularity-spectrum-visualization/concept-granularity-spectrum-visualization.png)
...
-   **[Concept Label Length Histogram](./concept-length-histogram/index.md)**
    ...
    ![Concept Label Length Histogram](./concept-length-histogram/concept-length-histogram.png)
...
-   **[Concept Label Length Optimization](./concept-label-length-optimization/index.md)**
    ...
    ![Concept Label Length Optimization](./concept-label-length-optimization/concept-label-length-optimization.png)
...
-   **[Concept Label Quality Checklist](./concept-label-quality-checklist/index.md)**
    ...
    ![Concept Label Quality Checklist](./concept-label-quality-checklist/concept-label-quality-checklist.png)
...
-   **[ConceptID vs ConceptLabel Comparison](./conceptid-vs-conceptlabel-comparison/index.md)**
    ...
    ![ConceptID vs ConceptLabel Comparison](./conceptid-vs-conceptlabel-comparison/conceptid-vs-conceptlabel-comparison.png)
...
-   **[Course Description Quality Rubric Visualization](./course-description-quality-rubric-visualization/index.md)**
    ...
    ![Course Description Quality Rubric Visualization](./course-description-quality-rubric-visualization/course-description-quality-rubric-visualization.png)
...
-   **[Cover Image Generation Workflow](./cover-image-workflow/index.md)**
    ...
    ![Cover Image Generation Workflow](./cover-image-workflow/cover-image-workflow.png)

    Interactive MicroSim for intelligent textbook learning workflows.

-   **[CSV File Format Example with Validation](./csv-file-format-example-with-validation/index.md)**

    ![CSV File Format Example with Validation](./csv-file-format-example-with-validation/csv-file-format-example-with-validation.png)
...
-   **[CSV to JSON Conversion Mapping Diagram](./csv-to-json-conversion-mapping-diagram/index.md)**
    ...
    ![CSV to JSON Conversion Mapping Diagram](./csv-to-json-conversion-mapping-diagram/csv-to-json-conversion-mapping-diagram.png)
...
-   **[DAG vs Cyclic Graph Comparison](./dag-vs-cyclic-graph-comparison/index.md)**
    ...
    ![DAG vs Cyclic Graph Comparison](./dag-vs-cyclic-graph-comparison/dag-vs-cyclic-graph-comparison.png)
...
-   **[Dependency Mapping Decision Tree](./dependency-mapping-decision-tree/index.md)**
    ...
    ![Dependency Mapping Decision Tree](./dependency-mapping-decision-tree/dependency-mapping-decision-tree.png)
...
-   **[Dependency Mapping Workflow](./dependency-mapping-workflow/index.md)**
    ...
    ![Dependency Mapping Workflow](./dependency-mapping-workflow/dependency-mapping-workflow.png)
...
-   **[Dependency Pattern Examples](./dependency-pattern-examples/index.md)**
    ...
    ![Dependency Pattern Examples](./dependency-pattern-examples/dependency-pattern-examples.png)
...
-   **[Dublin Core Metadata Field Reference Card](./dublin-core-metadata-field-reference-card/index.md)**
    ...
    ![Dublin Core Metadata Field Reference Card](./dublin-core-metadata-field-reference-card/dublin-core-metadata-field-reference-card.png)
...
-   **[Evolution of AI Approaches Timeline](./evolution-of-ai-approaches-timeline/index.md)**
    ...
    ![Evolution of AI Approaches Timeline](./evolution-of-ai-approaches-timeline/evolution-of-ai-approaches-timeline.png)
...
-   **[Evolution of AI: From Neural Networks to Claude Code](./claude-code-timeline/index.md)**
    ...
    ![Evolution of AI: From Neural Networks to Claude Code](./claude-code-timeline/claude-code-timeline.png)
...
-   **[FAQ Question Pattern Analysis Workflow](./faq-pattern-analysis/index.md)**
    ...
    ![FAQ Question Pattern Analysis Workflow](./faq-pattern-analysis/faq-pattern-analysis.png)
...
-   **[Five Levels of Textbook Intelligence Visual Model](./five-levels-of-textbook-intelligence-visual-model/index.md)**
    ...
    ![Five Levels of Textbook Intelligence Visual Model](./five-levels-of-textbook-intelligence-visual-model/five-levels-of-textbook-intelligence-visual-model.png)
...
-   **[Install Book Environment Dependencies](./install-book-env/index.md)**
    ...
    ![Install Book Environment Dependencies](./install-book-env/install-book-env.png)
...
-   **[Interactive Directory Navigation Practice MicroSim](./interactive-directory-navigation-practice-microsim/index.md)**
    ...
    ![Interactive Directory Navigation Practice MicroSim](./interactive-directory-navigation-practice-microsim/interactive-directory-navigation-practice-microsim.png)
...
-   **[Interactive Exercise Generator MicroSim](./interactive-exercise-generator-microsim/index.md)**
    ...
    ![Interactive Exercise Generator MicroSim](./interactive-exercise-generator-microsim/interactive-exercise-generator-microsim.png)
...
-   **[Interactive Learning Element Types Comparison](./interactive-learning-element-types-comparison/index.md)**
    ...
    ![Interactive Learning Element Types Comparison](./interactive-learning-element-types-comparison/interactive-learning-element-types-comparison.png)
...
-   **[Interactive Quiz Question Constructor MicroSim](./interactive-quiz-question-constructor-microsim/index.md)**
    ...
    ![Interactive Quiz Question Constructor MicroSim](./interactive-quiz-question-constructor-microsim/interactive-quiz-question-constructor-microsim.png)
...
-   **[ISO 11179 Principles Comparison Table Infographic](./iso-11179-principles-comparison-table-infographic/index.md)**
    ...
    ![ISO 11179 Principles Comparison Table Infographic](./iso-11179-principles-comparison-table-infographic/iso-11179-principles-comparison-table-infographic.png)
...
-   **[Iterative Prompt Refinement Metrics](./iterative-prompt-refinement-metrics/index.md)**
    ...
    ![Iterative Prompt Refinement Metrics](./iterative-prompt-refinement-metrics/iterative-prompt-refinement-metrics.png)

    Interactive Chart.js MicroSim for iterative prompt refinement metrics.

-   **[Learning Graph Color Test](./graph-color-test/index.md)**

    ![Learning Graph Color Test](./graph-color-test/graph-color-test.png)

    Interactive MicroSim for intelligent textbook learning workflows.

-   **[Learning Graph JSON Schema](./learning-graph-json-schema/index.md)**

    ![Learning Graph JSON Schema](./learning-graph-json-schema/learning-graph-json-schema.png)
...
-   **[Learning Graph Quality Score Calculator MicroSim](./learning-graph-quality-score-calculator-microsim/index.md)**
    ...
    ![Learning Graph Quality Score Calculator MicroSim](./learning-graph-quality-score-calculator-microsim/learning-graph-quality-score-calculator-microsim.png)
...
-   **[Learning Graph Structure Visualization](./learning-graph-structure-visualization/index.md)**
    ...
    ![Learning Graph Structure Visualization](./learning-graph-structure-visualization/learning-graph-structure-visualization.png)
...
-   **[Linear Chain vs Network Structure Comparison](./linear-chain-vs-network/index.md)**
    ...
    ![Linear Chain vs Network Structure Comparison](./linear-chain-vs-network/linear-chain-vs-network.png)
...
-   **[Lower-Order vs Higher-Order Thinking Skills](./lower-order-vs-higher-order-thinking-skills/index.md)**
    ...
    ![Lower-Order vs Higher-Order Thinking Skills](./lower-order-vs-higher-order-thinking-skills/lower-order-vs-higher-order-thinking-skills.png)

    Interactive p5.js MicroSim for lower-order vs higher-order thinking skills.

-   **[Major World Cities](./test-world-cities/index.md)**

    ![Major World Cities](./test-world-cities/test-world-cities.png)
...
-   **[Material Theme Features Interactive Comparison](./material-theme-features-interactive-comparison/index.md)**
    ...
    ![Material Theme Features Interactive Comparison](./material-theme-features-interactive-comparison/material-theme-features-interactive-comparison.png)
...
-   **[MicroSim File Relationship Diagram](./microsim-file-relationship-diagram/index.md)**
    ...
    ![MicroSim File Relationship Diagram](./microsim-file-relationship-diagram/microsim-file-relationship-diagram.png)
...
-   **[p5.js Architecture and Execution Model](./p5js-architecture/index.md)**
    ...
    ![p5.js Architecture and Execution Model](./p5js-architecture/p5js-architecture.png)
...
-   **[Permission Bits Visual Infographic](./permission-bits-visual-infographic/index.md)**
    ...
    ![Permission Bits Visual Infographic](./permission-bits-visual-infographic/permission-bits-visual-infographic.png)
...
-   **[Python Learning Graph Processing Pipeline](./python-learning-graph-processing-pipeline/index.md)**
    ...
    ![Python Learning Graph Processing Pipeline](./python-learning-graph-processing-pipeline/python-learning-graph-processing-pipeline.png)
...
-   **[Responsive Iframe Embedding MicroSim](./responsive-iframe-embedding-microsim/index.md)**
    ...
    ![Responsive Iframe Embedding MicroSim](./responsive-iframe-embedding-microsim/responsive-iframe-embedding-microsim.png)
...
-   **[Security Zones Diagram](./security-zones-diagram/index.md)**
    ...
    ![Security Zones Diagram](./security-zones-diagram/security-zones-diagram.png)

    Interactive Mermaid visualization showing security zones diagram

-   **[Sine Function Visualization](./sine-function-plot/index.md)**

    ![Sine Function Visualization](./sine-function-plot/sine-function-plot.png)
...
-   **[Skill Context Window](./skill-context-window/index.md)**
    ...
    ![Skill Context Window](./skill-context-window/skill-context-window.png)
...
-   **[Skill Development Priority Matrix Visualization](./skill-impact-chart/index.md)**
    ...
    ![Skill Development Priority Matrix Visualization](./skill-impact-chart/skill-impact-chart.png)
...
-   **[Skill Directory Structure](./skill-directory-structure/index.md)**
    ...
    ![Skill Directory Structure](./skill-directory-structure/skill-directory-structure.png)
...
-   **[Skill File Anatomy Diagram](./skill-file-anatomy-diagram/index.md)**
    ...
    ![Skill File Anatomy Diagram](./skill-file-anatomy-diagram/skill-file-anatomy-diagram.png)
...
-   **[Skill Installation Locations and Priority](./skill-installation-locations-and-priority/index.md)**
    ...
    ![Skill Installation Locations and Priority](./skill-installation-locations-and-priority/skill-installation-locations-and-priority.png)
...
-   **[Skill Installation Workflow](./skill-installation-workflow/index.md)**
    ...
    ![Skill Installation Workflow](./skill-installation-workflow/skill-installation-workflow.png)
...
-   **[Skill Invocation and Execution Lifecycle](./skill-invocation-and-execution-lifecycle/index.md)**
    ...
    ![Skill Invocation and Execution Lifecycle](./skill-invocation-and-execution-lifecycle/skill-invocation-and-execution-lifecycle.png)
...
-   **[Skill Package Contents Checklist](./skill-package-contents-checklist/index.md)**
    ...
    ![Skill Package Contents Checklist](./skill-package-contents-checklist/skill-package-contents-checklist.png)

    Interactive p5.js MicroSim for skill package contents checklist.

-   **[Skill Permission Matrix](./skill-permission-matrix/index.md)**

    ![Skill Permission Matrix](./skill-permission-matrix/skill-permission-matrix.png)
...
-   **[Skill Testing Workflow Diagram](./skill-testing-workflow-diagram/index.md)**
    ...
    ![Skill Testing Workflow Diagram](./skill-testing-workflow-diagram/skill-testing-workflow-diagram.png)
...
-   **[Skills vs Commands Decision Tree](./skills-vs-commands-decision-tree/index.md)**
    ...
    ![Skills vs Commands Decision Tree](./skills-vs-commands-decision-tree/skills-vs-commands-decision-tree.png)
...
-   **[Taxonomy Distribution Pie Chart](./taxonomy-distribution-pie/index.md)**
    ...
    ![Taxonomy Distribution Pie Chart](./taxonomy-distribution-pie/taxonomy-distribution-pie.png)
...
-   **[Terminal Workflow for Textbook Development](./terminal-workflow-textbook/index.md)**
    ...
    ![Terminal Workflow for Textbook Development](./terminal-workflow-textbook/terminal-workflow-textbook.png)
...
-   **[Topic-to-Concept Expansion Example](./topic-to-concept-expansion-example/index.md)**
    ...
    ![Topic-to-Concept Expansion Example](./topic-to-concept-expansion-example/topic-to-concept-expansion-example.png)
...
-   **[Topic-to-Concept Expansion Process](./topic-to-concept-expansion-process/index.md)**
    ...
    ![Topic-to-Concept Expansion Process](./topic-to-concept-expansion-process/topic-to-concept-expansion-process.png)
...
-   **[Transformer Architecture Diagram](./transformer-architecture-diagram/index.md)**
    ...
    ![Transformer Architecture Diagram](./transformer-architecture-diagram/transformer-architecture-diagram.png)
...
-   **[VS Code Interface Layout for Textbook Development](./vs-code-interface-layout-for-textbook-development/index.md)**
    ...
    ![VS Code Interface Layout for Textbook Development](./vs-code-interface-layout-for-textbook-development/vs-code-interface-layout-for-textbook-development.png)

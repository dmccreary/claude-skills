...
// CANVAS_HEIGHT: 560
  ...
  { name: "Level 2: Interactive Content", color: "#f97316", caps: ["Hyperlinks, videos, and MicroSims", "Quizzes and glossary", "Includes Level 1"] },
  { name: "Level 3: Adaptive Content", color: "#eab308", caps: ["Concept-graph traversal", "Personalized pathways", "Includes Levels 1-2"] },
  { name: "Level 4: Chatbot Integration", color: "#22c55e", caps: ["LLM-powered tutoring assistant", "GraphRAG question answering", "Includes Levels 1-3"] },
  { name: "Level 5: Autonomous AI", color: "#8b5cf6", caps: ["Generative, customized lessons", "Deep learner-state modeling", "Includes Levels 1-4"] }
];
...
function draw() {
  ...
  const top = baseY - 2 * stepH;
  rect(l2x - 8, top - 8, stepW + 16, stepH + 16, 10);
  noStroke();
  fill('#0f172a');
  textSize(13);

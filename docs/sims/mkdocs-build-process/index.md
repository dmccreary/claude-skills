...
```html
<iframe src="https://dmccreary.github.io/ibook-skills/sims/mkdocs-build-process/main.html" width="100%" height="600px"></iframe>
```
...
Illustrates the pipeline stages: markdown parsing, plugin processing, theme application, and HTML generation.
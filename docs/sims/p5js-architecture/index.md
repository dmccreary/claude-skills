---
title: p5.js Architecture and Execution Model
description: Interactive p5.js visualization showing p5.js architecture and execution model
image: /sims/p5js-architecture/p5js-architecture.png
og:image: /sims/p5js-architecture/p5js-architecture.png
quality_score: 80
---
...
```html
<iframe src="https://dmccreary.github.io/ibook-skills/sims/p5js-architecture/main.html" width="100%" height="600px"></iframe>
```

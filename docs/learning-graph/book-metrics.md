...
| 5 | Chapter Quizzes | 14 / 17 | Recommended | Chapters with a quiz.md (140 questions total) |
| 6 | Chapter References | 0 / 17 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 208 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 66 | Recommended | Questions in faq.md |
| 9 | Words | 178,737 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 76 | 75 | H4 headers starting with '#### Diagram:' |
| Equations | 130 | 28 | LaTeX expressions (inline and display) |
| Total Words | 178,737 | 87,853 | Words in markdown files |
| Links | 975 | 202 | Hyperlinks in markdown format |
| Equivalent Pages | 780 | 417 | Estimated pages (250 words/page + visuals) |

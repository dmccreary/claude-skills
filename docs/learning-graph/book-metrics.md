...
|---|---------|-------|--------|-------|
| 1 | Concepts | 570 | Required | Concepts from learning graph |
| 2 | Chapters | 31 | Required | Chapter directories with index.md |
| 3 | MicroSims | 94 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 0 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 1 / 31 | Recommended | Chapters with a quiz.md (0 questions total) |
| 6 | Chapter References | 0 / 31 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 570 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 66 | Recommended | Questions in faq.md |
| 9 | Words | 169,032 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 27 | 26 | H4 headers starting with '#### Diagram:' |
| Equations | 131 | 1 | LaTeX expressions (inline and display) |
| Total Words | 169,032 | 49,380 | Words in markdown files |
| Links | 1167 | 316 | Hyperlinks in markdown format |
| Equivalent Pages | 729 | 251 | Estimated pages (250 words/page + visuals) |

...
| 9 | Words | 154,857 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 25 | 24 | H4 headers starting with '#### Diagram:' |
| Equations | 131 | 1 | LaTeX expressions (inline and display) |
| Total Words | 154,857 | 35,205 | Words in markdown files |
| Links | 1103 | 252 | Hyperlinks in markdown format |
| Equivalent Pages | 672 | 193 | Estimated pages (250 words/page + visuals) |

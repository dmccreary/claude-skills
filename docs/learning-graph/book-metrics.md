...
**Generated on**: December 07, 2025 at 06:46 AM
...
| MicroSims | 35 | [Simulations](../sims/index.md) | Interactive MicroSims |
...
|-------------|-------------|---------------|-------|
| Diagrams | 77 | 76 | H4 headers starting with '#### Diagram:' |
| Equations | 74 | 27 | LaTeX expressions (inline and display) |
| Total Words | 151,892 | 85,791 | Words in markdown files |
| Links | 595 | 200 | Hyperlinks in markdown format |
| Equivalent Pages | 644 | 379 | Estimated pages (250 words/page + visuals) |

...
It reads from existing metrics files generated by the book metrics tooling (`bk-generate-book-metrics`, available via the book-installer book-metrics guide).

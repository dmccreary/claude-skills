...
3. Read chapter 12 index.md file at `$HOME/Documents/ws/ibook-skills/docs/chapters/12-interactive-elements-microsims/index.md`
...
2. Read three critical reference files in parallel:
   ...
   - `$HOME/Documents/ws/ibook-skills/docs/course-description.md` (121 lines)
...
**File updated:**
- Path: `$HOME/Documents/ws/ibook-skills/docs/chapters/12-interactive-elements-microsims/index.md`
